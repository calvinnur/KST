...
WebUI.callTestCase(findTestCase('checkOut Scenarios/Function/add 2 products'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('checkOut Scenarios/Function/check 2 products'), [:], FailureHandling.STOP_ON_FAILURE)
